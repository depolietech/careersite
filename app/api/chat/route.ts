      ...
      case "talent": {
        if (!userId || userRole !== "EMPLOYER") {
          ...
          response = {
            reply: L(
              lang,
              `The **Talent Pool** tab has **${seekerCount} anonymous candidate profile${seekerCount !== 1 ? "s" : ""}** you can browse.\n\nFilter by:\n• **Skill** (e.g. React, Python)\n• **Location** (e.g. Ontario, Texas)\n• **Min. experience** (years)\n\nAll profiles are fully anonymous. Scheduling an interview reveals the candidate's identity.`,
              `L'onglet **Bassin de talents** contient **${seekerCount} profil${seekerCount !== 1 ? "s" : ""} anonyme${seekerCount !== 1 ? "s" : ""}** que vous pouvez parcourir.\n\nFiltrez par :\n• **Compétence** (ex. React, Python)\n• **Lieu** (ex. Ontario, Texas)\n• **Expérience min.** (années)\n\nTous les profils sont entièrement anonymes.`,
              `La pestaña **Grupo de talentos** tiene **${seekerCount} perfil${seekerCount !== 1 ? "es" : ""}** anónimo${seekerCount !== 1 ? "s" : ""} que puedes explorar.\n\nFiltra por:\n• **Habilidad** (ej. React, Python)\n• **Ubicación** (ej. Ontario, Texas)\n• **Experiencia mín.** (años)\n\nTodos los perfiles son completamente anónimos.`
            ),
            suggestions: LA(
              lang,
