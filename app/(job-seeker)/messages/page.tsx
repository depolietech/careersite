  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Your conversations with recruiters.</p>
      </div>
      ...
      <div className="rounded-xl bg-brand-50 border border-brand-100 px-4 py-3 text-sm text-brand-800 flex items-center gap-2">
        ...
        Your identity remains anonymous in all conversations until an interview is scheduled.
      </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    <p className="font-semibold text-gray-900 truncate">{c.jobTitle}</p>
